...
namespace LeapVR.Shell.Controllers {
    /// <summary>
    ...
    public class MyEventAggregator : IEventAggregator {
        ...
        public virtual void Publish(object message, Action<global::System.Action> marshal) {
            if (message == null){
            ...
            marshal(() => TheInvoke(message, toNotify));
        }

        public void TheInvoke(object message,Handler[] toNotify)
        {
