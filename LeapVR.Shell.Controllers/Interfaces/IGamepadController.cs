#region Licence
/****************************************************************
 *  Filename: IGamepadController.cs
 *  ----------------------------------------------------------
...
namespace LeapVR.Shell.Controllers.Interfaces
{
    ...
    {
        bool IsEnabled { get; }
        XInputButtons ConfirmButton { get; }
        XInputButtons CancelButton { get; }
        IObservable<XInputButtonArgs> WhenXInputButtonStateChanged { get; }
        void RegisterTerminateAllApplications(Action terminationAction);
        void RegisterResetStationState(Action resetStationAction);
    }
}
