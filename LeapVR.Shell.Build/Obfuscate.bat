...
set confuserProjectFile=%~dp0LeapVR.Build.ConfuserEx.crproj
set sourceDir=%~dp0Obfuscation_Input
set obfuscatedDir=%~dp0Obfuscation_Temp
set destDir=%~dp0Obfuscation_Output
set fileCntExpected=35
