#region Licence
/****************************************************************
 *  Filename: WarnStorageChangeViewModel.cs
 *  ----------------------------------------------------------
...
{
    public class WarnStorageChangeViewModel : Screen
    {
        private string _testString = "MyTest";
        private readonly DialogHost _dialogHost;

        public WarnStorageChangeViewModel(DialogHost dialogHost) { _dialogHost = dialogHost; }
