#region Licence
/****************************************************************
 *  Filename: IProcessExecutionLogic.cs
 *  ----------------------------------------------------------
...
namespace LeapVR.Shell.Domain.Models.App
{
    ...
    public interface IProcessExecutionLogic
    {
         /// <summary>
        ...
        /// </summary>
        IProcessMonitorInstruction[] MonitorInstructions { get;  }
        ...
        /// </value>
        string ReguiredVrModuleGuid { get; }
