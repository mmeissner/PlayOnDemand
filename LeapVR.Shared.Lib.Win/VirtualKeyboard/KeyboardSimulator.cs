...
namespace LeapVR.Shared.Lib.Win.VirtualKeyboard
{
    ...
    /// </summary>
    class KeyboardSimulator : IKeyboardSimulator
    {
        private readonly IInputSimulator _inputSimulator;

        /// <summary>
        /// The instance of the <see cref="IInputMessageDispatcher"/> to use for dispatching <see cref="WindowsInput.INPUT"/> messages.
        /// </summary>
        private readonly IInputMessageDispatcher _messageDispatcher;

        /// <summary>
        /// Initializes a new instance of the <see cref="KeyboardSimulator"/> class using an instance of a <see cref="WindowsInputMessageDispatcher"/> for dispatching <see cref="WindowsInput.INPUT"/> messages.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyboardSimulator"/> class using the specified <see cref="IInputMessageDispatcher"/> for dispatching <see cref="WindowsInput.INPUT"/> messages.
        /// </summary>
        /// <param name="inputSimulator">The <see cref="IInputSimulator"/> that owns this instance.</param>
        /// <param name="messageDispatcher">The <see cref="IInputMessageDispatcher"/> to use for dispatching <see cref="WindowsInput.INPUT"/> messages.</param>
        ...
        internal KeyboardSimulator(IInputSimulator inputSimulator, IInputMessageDispatcher messageDispatcher)
        {
            ...
            if (messageDispatcher == null)
                throw new InvalidOperationException(
                    ...
                    typeof(KeyboardSimulator).Name, typeof(IInputMessageDispatcher).Name, typeof(Native.Input).Name));
        ...
        /// <summary>
        /// Sends the list of <see cref="WindowsInput.INPUT"/> messages using the <see cref="IInputMessageDispatcher"/> instance.
        /// </summary>
        /// <param name="inputList">The <see cref="System.Array"/> of <see cref="WindowsInput.INPUT"/> messages to send.</param>
        private void SendSimulatedInput(Native.Input[] inputList)
        {
