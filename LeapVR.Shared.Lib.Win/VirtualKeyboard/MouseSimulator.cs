...
namespace LeapVR.Shared.Lib.Win.VirtualKeyboard
{
    ...
    /// </summary>
    class MouseSimulator : IMouseSimulator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MouseSimulator"/> class using an instance of a <see cref="WindowsInputMessageDispatcher"/> for dispatching <see cref="WindowsInput.INPUT"/> messages.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MouseSimulator"/> class using the specified <see cref="IInputMessageDispatcher"/> for dispatching <see cref="WindowsInput.INPUT"/> messages.
        /// </summary>
        /// <param name="inputSimulator">The <see cref="IInputSimulator"/> that owns this instance.</param>
        ...
        internal MouseSimulator(IInputSimulator inputSimulator, IInputMessageDispatcher messageDispatcher)
        {
            ...
            if (messageDispatcher == null)
                throw new InvalidOperationException(
                    ...
                    typeof(MouseSimulator).Name, typeof(IInputMessageDispatcher).Name, typeof(Native.Input).Name));
