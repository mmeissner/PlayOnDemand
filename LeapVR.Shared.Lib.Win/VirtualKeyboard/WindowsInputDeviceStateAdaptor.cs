#region Licence
/****************************************************************
 *  Filename: WindowsInputDeviceStateAdaptor.cs
 *  ----------------------------------------------------------
...
namespace LeapVR.Shared.Lib.Win.VirtualKeyboard
{
    ...
    /// </summary>
    class WindowsInputDeviceStateAdaptor : IInputDeviceStateAdaptor
    {
        ...
        /// </summary>
        /// <param name="keyCode">The <see cref="WindowsInput.VirtualKeyCode"/> for the key.</param>
        /// <returns>
        ...
        {
            Int16 result = User32.GetKeyState((UInt16)keyCode);
            return (result < 0);
        }
