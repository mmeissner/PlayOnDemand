#region Licence
/****************************************************************
 *  Filename: EditPlatformDataViewModel.cs
 *  ----------------------------------------------------------
...
{
    public class EditPlatformDataViewModel : ValidatingScreen, IStepScreenEdit
    {
        ...
        public EditPlatformDataViewModel(LeapVrContainerEditor containerEditor)
        {
